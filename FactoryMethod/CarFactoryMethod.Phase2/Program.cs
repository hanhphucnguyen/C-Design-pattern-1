...
namespace CarFactoryMethod.Phase2
{
    class Program
    {
        ...
        {
            // note that inherited factory types are easily interchangeable
            CarFactory carFactory = new CarFactory();
            //CarFactory carFactory = new CarAndMotorcycleFactory();
            ...
            while (keepMakingCars)
            {
                ...
                // note that we don't need to make any updates to the client code to allow for this
